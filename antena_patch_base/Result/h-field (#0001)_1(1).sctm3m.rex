...
<MetaResultFile version="20210114" creator="FD-Control">
  ...
  <SimulationProperties fieldname="surface current (f=2.5) [1]" frequency="2.5" encoded_unit="&amp;U:A^1.:m^-1" quantity="surf_current" fieldtype="Surface current" fieldscaling="PEAK" dB_Amplitude="20"/>
