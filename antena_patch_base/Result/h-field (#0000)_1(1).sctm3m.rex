...
<MetaResultFile version="20210114" creator="FD-Control">
  ...
  <SimulationProperties fieldname="surface current (f=4) [1]" frequency="4" encoded_unit="&amp;U:A^1.:m^-1" quantity="surf_current" fieldtype="Surface current" fieldscaling="PEAK" dB_Amplitude="20"/>
