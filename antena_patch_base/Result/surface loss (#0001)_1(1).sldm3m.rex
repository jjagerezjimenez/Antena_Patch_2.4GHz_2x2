...
<MetaResultFile version="20210114" creator="FD-Control">
  ...
  <SimulationProperties fieldname="loss (f=2.5) [1]" frequency="2.5" encoded_unit="&amp;U:W^1.:m^-2" quantity="surf_loss_density" fieldtype="Surface power loss dens." fieldscaling="UNDEFINED" dB_Amplitude="10"/>
